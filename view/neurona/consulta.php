        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nuevo Analisis</h5>
    ...
    $.ajax({
        ...
        success: function (data) {
          ...
          console.log('Respuesta del servidor Mascota Tipo Neurona>>:', data); 
             ...
             console.log("data[0].VAR3",valorSeleccionadoTratamiento);
          $.ajax({
                    ...
                    console.log('Datos enviados y procesados>2:', response);
                       ...
                       // Crear una nueva instancia de la red neuronal
                        ...
                        const trainingData = Datos_vec.map(item => ({
                            ...
                            const porcentaje = (resultado.efectividad_1 * 1000).toFixed(1) + '%';
                            $('#efectividad_trat').val(porcentaje);

                              //efectividad_trat
                            //  $('#efectividad_trat').val(10*resultado.efectividad_1);
