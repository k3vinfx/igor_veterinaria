...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-6">
        <h1 class="h3 mb-0 text-gray-800">Antecedentes Clinicos</h1>
                ...
                <table class="table table-striped table-bordered" id="table">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>Tratamientos Cuidados Realizados</th>
                            <th>Cirugias Anteriores</th>
                            <th>Observaciones</th>
                            <th>Fecha</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $r->idAntecedentes; ?></td>
                            <td><?php echo $r->pesoAntecedentes; ?></td>
                            <td><?php echo $r->alturaAntecedentes; ?></td>
                            <td><?php echo $r->alergicoAntecedentes; ?></td>
                            <td><?php echo $r->grupoSanguineoAntecedentes; ?></td>
                            <td><?php echo $r->enfermedadesPadecidasAntecedentes; ?></td>
                            <td><?php echo $r->tratamientosCuidadosAntecedentes; ?></td>
                            <td><?php echo $r->cirugiasAntecedentes; ?></td>
                            <td><?php echo $r->observacionExtraAntecedentes; ?></td>
                            <td><?php echo $r->fechaAntecedentes; ?></td>
                            ...
                            <td>
                                 ...
                                 <button type="button" id="btnEditar" name="btnEditar" class="btn btn-success btnEditar"
                                  ...
                                  data-id="<?php echo $r->idAntecedentes; ?>"
                                  data-peso="<?php echo $r->pesoAntecedentes; ?>"
                                  data-altura="<?php echo $r->alturaAntecedentes; ?>"
                                  data-alergico="<?php echo $r->alergicoAntecedentes; ?>"
                                  data-tipoSangre="<?php echo $r->grupoSanguineoAntecedentes; ?>"
                                  data-enfermedades="<?php echo $r->enfermedadesPadecidasAntecedentes; ?>"
                                  data-tratamientos="<?php echo $r->tratamientosCuidadosAntecedentes; ?>"
                                  data-cirugias="<?php echo $r->tratamientosCuidadosAntecedentes; ?>" 
                                  data-extra="<?php echo $r->observacionExtraAntecedentes; ?>"                              
